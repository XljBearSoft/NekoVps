...
<head lang="en">
  ...
  <link rel="alternate icon" type="image/png" href="/nekovpn/Public/assets/i/favicon.png">
  <link rel="stylesheet" href="/nekovpn/Public/assets/css/amazeui.min.css"/>
  <style>
    .get {
      background: #1E5B94;
      color: #fff;
...
<div class="hope">
  <div class="am-g am-container">
    <div class="am-u-lg-4 am-u-md-6 am-u-sm-12 hope-img">
      <img src="/nekovpn/Public/assets/i/examples/landing.png" alt="" data-am-scrollspy="{animation:'slide-left', repeat: false}">
...
<script src="/nekovpn/Public/assets/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/nekovpn/Public/assets/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="/nekovpn/Public/assets/js/amazeui.min.js"></script>
</body>
</html>